...
export default function SubmitButton({ mode, isLoading }) {
    return (
        <button
            type="submit"
            className={`bg-mediumgreen block text-lg w-full mt-8 py-2 rounded text-white font-semibold bg-opacity-90 transition duration-150 ease-in-out transform hover:scale-105
